    ...
    <div className="container mx-auto my-3 md:my-10 px-5 md:px-10">
      ...
      <div className=" flex flex-col-reverse  items-center gap-5 px-4 py-8 lg:flex-row lg:gap-10 lg:px-16">
        <div className="text-center lg:text-left">
          ...
          <p className="mt-3 text-base leading-6 lg:mt-5 lg:text-lg lg:leading-8">
            ...
            innovation and problem-solving, I design and build web applications
            that are not only functional but also scalable, user-friendly, and
            visually appealing.
          </p>
        </div>
      ...
      <div className="py-4 md:py-8">
        ...
        <p className="mt-3 text-base leading-6 lg:mt-5 lg:text-lg ">
          My journey into web development began in 2020 during my first semester
          at university. What started as curiosity quickly turned into a
          ...
          fan of TanStack Query previously known as React Query which is a data
          fetching library for React. I also know React Router which is a
          collection of navigational components that compose declaratively with
          your application. Then I get to know Tanstack Router which is
          alternative to React Router but the benefit of Tanstack Router is it
          is type safe and encourage to use typescript. Recently, I also get to
          know Zod which is used to data validation. I also know how to use
        ...
        <div className="mt-3 text-base leading-6 lg:mt-5 lg:text-lg ">
          ...
          <div>
            ...
            <div className="px-4  md:px-6">
              <div className="flex items-center gap-2 px-2">
                ...
                <span className="text-sm md:text-base lg:text-lg">React</span>
              </div>
              <div className="flex items-center gap-2 px-2">
                <LuBadgeCheck className="w-4 h-4  flex-shrink-0" />
              ...
              <div className="flex items-center gap-2 px-2">
                <LuBadgeCheck className="w-4 h-4  flex-shrink-0" />
                <span className="text-sm md:text-base lg:text-lg">DaisyUI</span>
              </div>
              <div className="flex items-center gap-2 px-2">
                <LuBadgeCheck className="w-4 h-4  flex-shrink-0" />
                <span className="text-sm md:text-base lg:text-lg">
          ...
          <div>
            ...
            <div className="px-4  md:px-6">
              <div className="flex items-center gap-2 px-2">
                <LuBadgeCheck className="w-4 h-4  flex-shrink-0" />
                <span className="text-sm md:text-base lg:text-lg">Node.JS</span>
              </div>
              <div className="flex items-center gap-2 px-2">
                <LuBadgeCheck className="w-4 h-4  flex-shrink-0" />
                <span className="text-sm md:text-base lg:text-lg">
              ...
              <div className="flex items-center gap-2 px-2">
                <LuBadgeCheck className="w-4 h-4  flex-shrink-0" />
                <span className="text-sm md:text-base lg:text-lg">MongoDB</span>
              </div>
              <div className="flex items-center gap-2 px-2">
                <LuBadgeCheck className="w-4 h-4  flex-shrink-0" />
                <span className="text-sm md:text-base lg:text-lg">
          ...
          <div>
            <div className="flex items-center gap-2 px-2">
              <FaFeatherPointed className="w-4 h-4  flex-shrink-0" />
              <p className="py-2 font-medium">
                Developing RESTful APIs and integrating authentication systems
                with
              </p>
            </div>
            <div className="px-4  md:px-6">
              ...
              <div className="flex items-center gap-2 px-2">
                <LuBadgeCheck className="w-4 h-4  flex-shrink-0" />
                <span className="text-sm md:text-base lg:text-lg">OAuth</span>
              </div>
              <div className="flex items-center gap-2 px-2">
                <LuBadgeCheck className="w-4 h-4  flex-shrink-0" />
                <span className="text-sm md:text-base lg:text-lg">
      ...
      <div className="py-4 md:py-8">
        ...
        <div className="mt-3 text-base leading-6 lg:mt-5 lg:text-lg ">
          ...
          <div className="flex items-center gap-2 p-2">
            ...
            <p>
              <span className="font-medium">Problem-Solving Mindset:</span> I
              excel at analyzing challenges, debugging issues, and finding
              efficient solutions.
            </p>
          </div>
          <div className="flex items-center gap-2 p-2">
            <TbTransformPointTopLeft className="w-4 h-4  flex-shrink-0" />
            <p>
              <span className="font-medium"> Continuous Learner:</span> I stay
              updated with emerging tools and technologies to keep my skills
              sharp.
            </p>
          </div>
          <div className="flex items-center  gap-2 p-2">
            <TbTransformPointTopLeft className="w-4 h-4  flex-shrink-0" />
            <p>
              <span className="font-medium">Commitment to Excellence:</span> I
              approach every project with attention to detail, ensuring
              high-quality results. By choosing me, you're partnering with
              someone who's not just a coder but a collaborator focused on your
              success.
            </p>
          </div>
        </div>
      ...
      <div className="py-4 md:py-8">
        ...
        <p className="mt-3 text-base leading-6 lg:mt-5 lg:text-lg ">
          I am based in Bangladesh, where I've spent years honing my skills and
          exploring the ever-evolving world of technology. Beyond coding, I
          enjoy a range of activities that fuel my creativity and passion.
          <br></br> When I'm not writing code, you'll often find me solving
          Rubik's Cubes, diving into tech blogs and videos, or reading about the
          latest advancements in web development. I consider myself an extrovert
          and enjoy engaging in conversations. Interestingly, I always manage to
          find a common topic with anyone I talk to—be it about technology,
          movies, series, sports, or anime.<br></br> I am a PC enthusiast who
          enjoys staying up-to-date on the latest computer components through
          YouTube and Facebook groups. I'm also a gamer, primarily playing
          story-driven PC games that allow me to immerse myself in the role of a
          character. One of my favorite games is Uncharted 4.<br></br> In my
          leisure time, I enjoy watching anime, series, or movies. Additionally,
          I have a passion for working with electrical tools. I own a soldering
          iron and often try fixing broken items or building DIY projects. While
          my experiments don't always succeed, I thoroughly enjoy the process of
          tinkering and creating.<br></br> I also enjoy reading books and
          spending time with friends. My evenings are usually spent hanging out
          with friends, taking short tours around our local area, and sharing
          lively conversations over tea at a nearby stall. I find joy in
          connecting with people and discussing various topics.<br></br> In
          terms of education, I have had the privilege of experiencing different
          schools throughout my academic journey. I completed my SSC in 2016
          from Collectorate Adarsha Shikkha Niketan in Panchagarh and my HSC in
          2018 from Cantonment Public School and College. In 2020, I enrolled at
      ...
      <div className="py-4 md:py-8">
        ...
        <p className="mt-3 text-base leading-6 lg:mt-5 lg:text-lg ">
          Telegram: <a href="https://t.me/samiul_karim_shrabon">Samiul Karim</a>
        </p>
        <p className="mt-3 text-base leading-6 lg:mt-5 lg:text-lg ">
          Facebook:{" "}
